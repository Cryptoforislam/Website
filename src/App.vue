  ...
  <section class="w-full px-6 pb-12 antialiased bg-white" data-tails-scripts="//unpkg.com/alpinejs">
    <div class="mx-auto max-w-7xl">
      ...
      <div class="container max-w-lg px-4 py-32 mx-auto mt-px text-left md:max-w-none md:text-center">
        ...
        <div class="mx-auto mt-5 text-gray-500 md:mt-12 md:max-w-lg md:text-center lg:text-lg">Simplifying the creation
          of landing pages, blog pages, application pages and so much more!</div>
...
import ij_gh from './components/ij_gh.vue'
import hdf_fj from './components/hdf_fj.vue'
import feature_l from './components/feature_l.vue'
import testi_list from './components/testi_list.vue'
import faq_me from './components/faq_me.vue'
import donate_com from './components/donate_com.vue'


export default {
  name: 'App',
  components: {
    ij_gh, hdf_fj, blog_fetch, feature_l, testi_list, faq_me, donate_com
  }
}
</script>
