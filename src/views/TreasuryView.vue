<template>
	<div class="max-w-xl m-auto py-60 px-10">
		<div class="text-center space-y-5">
			<div class="mt-1 font-extrabold  uppercase">
			...
			<a href="https://debank.com/profile/0xe2e2703fefb70d019e3bb1b8f0bf6414f1f10f3d"
...
export default {
	...
	async mounted() {
		try {
			...
			const amount = await Yuh.balanceOf(
				'0xe2e2703fefb70d019e3bb1b8f0bf6414f1f10f3d',
			)

			this.amount = ethers.utils.formatEther(amount.toString(), 18)
		} catch (e) {
			console.log(e)
		}
	},
