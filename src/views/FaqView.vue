		...
		<div class="px-8 mx-auto max-w-7xl lg:px-16">
			...
			<div class="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
				<div>
					...
					<p>Crypto for Islam will spend 100% of the donations received on the welfare of Muslims around the world. All the
					...
					<p>
						Crypto for Islam works everywhere in the world where our Muslim brothers need help. No matter what place you
						reside in this world if you are Muslim Crypto for Islam will help you out and provide you with a better life.
					</p>
				...
				<div>
					...
					<p>
						No, you can not donate in fiat. Crypto for Islam only accepts payment in crypto.
					</p>
				</div>
			</div>
		</div>
