		...
		<div class="px-8 mx-auto max-w-7xl lg:px-16">
			...
			<div class="grid grid-cols-1 gap-0 text-gray-600 md:grid-cols-2 md:gap-16">
				<div>
					...
					<p>
						Crypto for Islam will spend 100% of the donations received on the welfare of Muslims around the
						world. All the money donated will be used in our various programs with the input of the
						volunteers.
					</p>
					<h5 class="mt-10 mb-3 font-semibold text-gray-900">Which countries does Crypto for Islam work in?
					</h5>
					<p>
						Crypto for Islam works everywhere in the world where our Muslim brothers need help. No matter
						what place you reside in this world if you are Muslim Crypto for Islam will help you out and
				...
				<div>
					...
					<p>Yes, you can volunteer from anywhere, Crypto for Islam welcomes everyone who wants to spread our
						noble cause and help.</p>
