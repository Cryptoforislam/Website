          ...
          <div class="box-border flex items-center justify-start pt-12">
            ...
            <div class="pl-8 leading-6 text-left">
              ...
              <div class="box-border text-base leading-normal text-gray-700">
                An ever-flowing charity,Sadaqah Jariyah provides clean water so
        ...
        <div class="relative w-full col-span-3 px-4 leading-6 text-left">
          <div class="box-border flex items-center justify-start pt-12">
            ...
            <div class="pl-8 leading-6 text-left">
              ...
              <div class="box-border text-base leading-normal text-gray-700">
                Providing access to education & creating powerful antidotes to
                unrest, distrust, & war
              </div>
            </div>
          </div>
        ...
        <div class="relative w-full col-span-3 px-4 leading-6 text-left">
          <div class="box-border flex items-center justify-start pt-12">
            ...
            <div class="pl-8 leading-6 text-left">
              ...
              <div class="box-border text-base leading-normal text-gray-700">
                Delivering urgent food in Ramadan & year round to relieve
                starvation.
              </div>
            </div>
          </div>
