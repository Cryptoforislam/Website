<template>
  <div class="max-w-xl m-auto py-60 px-10">
    <div class="text-center space-y-5">
      <div
        class="mt-1 font-extrabold text-gray-900 sm:text-5xl uppercase"
      >
        ...
        <div class="text-7xl py-5">
          <span class="px-2 py-1 relative inline-block">
            <svg
              class="stroke-current bottom-0 absolute text-pink-400 -translate-x-2"
              viewBox="0 0 410 18"
  ...
  methods: {
    ...
    async sub_create() {
      try {
        ...
        const amount_x = ethers.utils.parseEther(
